...
public:
	...
	Road():nom("Boulevard Saint Paul"),  fileDeVehicule(nullptr), direction(Direction::Nord){}
	~Road() = default; // il n'est pas proprietaire de ses files
